...
def test_canonical_phone_ignores_lid():
    assert canonical_phone("5541999990000@lid") == ""
...
def test_whatsapp_workflow_id_uses_phone_digits():
    assert whatsapp_workflow_id("dsg", "5541999990000@s.whatsapp.net") == "whatsapp-dsg-5541999990000"


def test_whatsapp_workflow_id_keeps_lid_distinct_from_phone():
    assert whatsapp_workflow_id("dsg", "5541999990000@lid") == "whatsapp-dsg-5541999990000-lid"
